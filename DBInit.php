...
class DBInit {
    ...
    private static $host = ""; // add your host (can be localhost if hosted on the same IP)
    private static $user = ""; // add you username and password
    private static $password = "";
    private static $schema = ""; // add your schema name
